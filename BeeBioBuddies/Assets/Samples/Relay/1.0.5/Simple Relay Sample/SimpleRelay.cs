...
public class SimpleRelay : MonoBehaviour
{
    ...
    async void Start()
    {
        await UnityServices.InitializeAsync();  // bu kodu yazmazsak gaming services ile ilgili işlem yaparken hata alırız
    ...
    public async void OnAllocate()
    {
        ...
        Allocation allocation = await RelayService.Instance.CreateAllocationAsync(4, region); // oyuncu sayısı 4 belirlenmiş
